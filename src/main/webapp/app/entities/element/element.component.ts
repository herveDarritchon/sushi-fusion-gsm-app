...
export default class Element extends mixins(JhiDataUtils) {
  ...
  public retrieveAllElements(): void {
  ...
  public prepareRemove(instance: IElement): void {
  ...
  public removeElement(): void {
    this.elementService()
      ...
      .then(() => {
        const message = 'A Element is deleted with identifier ' + this.removeId;
