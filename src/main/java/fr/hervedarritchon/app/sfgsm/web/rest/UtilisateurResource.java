...
/**
 * REST controller for managing {@link fr.hervedarritchon.app.sfgsm.domain.Utilisateur}.
 */
@RestController
@RequestMapping("/api")
public class UtilisateurResource {
    ...
    public List<UtilisateurDTO> getAllUtilisateurs(@RequestParam(required = false) String filter) {
        if ("client-is-null".equals(filter)) {
            log.debug("REST request to get all Utilisateurs where client is null");
            return utilisateurService.findAllWhereClientIsNull();
        }
